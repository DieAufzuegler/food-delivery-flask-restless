...
commands = [
    ...
    [
        ...
        'curl -H "Content-Type: application/json" -i -X PUT -d \'{ "on_duty": true, "has_order_assigned": true, "assigned_order": 1 }\' http://localhost:5000/api/deliveryperson/1'
    ],
    [
        'Get delivery person with ID 1',
        'curl -H "Content-Type: application/json" -i http://localhost:5000/api/deliveryperson/1'
    ],
]
